...
void
readu128BE(uint8_t *buffer, uint128_t *target)
{
...
void
readu256BE(uint8_t *buffer, uint256_t *target)
{
...
static uint64_t
readUint64(const uint8_t u8[static 8])
{
  uint64_t u64;
...
void
readu128(const uint8_t *buffer, uint128_t *target)
{
  UPPER_P(target) = readUint64(buffer);
  LOWER_P(target) = readUint64(buffer + 8);
}

void
readu256(const uint8_t *buffer, uint256_t *target)
{
  readu128(buffer, &UPPER_P(target));
  readu128(buffer + 16, &LOWER_P(target));
}

bool
zero128(const uint128_t *number)
{
  return ((LOWER_P(number) == 0) && (UPPER_P(number) == 0));
}

bool
zero256(const uint256_t *number)
{
  return (zero128(&LOWER_P(number)) && zero128(&UPPER_P(number)));
}

void
copy128(uint128_t *target, const uint128_t *number)
{
...
void
copy256(uint256_t *target, const uint256_t *number)
{
...
void
shiftl128(const uint128_t *number, const uint32_t value, uint128_t *target)
{
  if (value >= 128)
  {
    clear128(target);
...
void
shiftl256(const uint256_t *number, const uint32_t value, uint256_t *target)
{
  if (value >= 256)
  {
    clear256(target);
...
void
shiftr128(const uint128_t *number, const uint32_t value, uint128_t *target)
{
  if (value >= 128)
  {
    clear128(target);
...
void
shiftr256(const uint256_t *number, const uint32_t value, uint256_t *target)
{
  if (value >= 256)
  {
    clear256(target);
...
uint32_t
bits128(const uint128_t *number)
{
  uint32_t result = 0;
  if (UPPER_P(number))
  {
...
uint32_t
bits256(const uint256_t *number)
{
  uint32_t result = 0;
...
bool
equal128(const uint128_t *number1, const uint128_t *number2)
{
...
bool
equal256(const uint256_t *number1, const uint256_t *number2)
{
...
bool
gt128(const uint128_t *number1, const uint128_t *number2)
{
...
bool
gt256(const uint256_t *number1, const uint256_t *number2)
{
...
bool
gte128(const uint128_t *number1, const uint128_t *number2)
{
  return gt128(number1, number2) || equal128(number1, number2);
}

bool
gte256(const uint256_t *number1, const uint256_t *number2)
{
  return gt256(number1, number2) || equal256(number1, number2);
}

void
add128(const uint128_t *number1, const uint128_t *number2, uint128_t *target)
{
  UPPER_P(target)
...
void
add256(const uint256_t *number1, const uint256_t *number2, uint256_t *target)
{
  uint128_t tmp;
...
void
minus128(const uint128_t *number1, const uint128_t *number2, uint128_t *target)
{
  UPPER_P(target)
      = UPPER_P(number1) - UPPER_P(number2)
        - ((LOWER_P(number1) - LOWER_P(number2)) > LOWER_P(number1));
...
void
minus256(const uint256_t *number1, const uint256_t *number2, uint256_t *target)
{
  uint128_t tmp;
...
void
or128(const uint128_t *number1, const uint128_t *number2, uint128_t *target)
{
...
void
or256(const uint256_t *number1, const uint256_t *number2, uint256_t *target)
{
...
void
mul128(const uint128_t *number1, const uint128_t *number2, uint128_t *target)
{
...
void
mul256(const uint256_t *number1, const uint256_t *number2, uint256_t *target)
{
  uint128_t top[4];
  uint128_t bottom[4];
...
void
divmod128(const uint128_t *l, const uint128_t *r, uint128_t *retDiv,
          uint128_t *retMod)
{
...
void
divmod256(const uint256_t *l, const uint256_t *r, uint256_t *retDiv,
          uint256_t *retMod)
{
...
static void
reverseString(char *str, uint32_t length)
{
  uint32_t i, j;
...
bool
tostring128(const uint128_t *number, uint32_t baseParam, char *out,
            uint32_t outLength)
{
  uint128_t rDiv;
  uint128_t rMod;
...
bool
tostring256(const uint256_t *number, uint32_t baseParam, char *out,
            uint32_t outLength)
{
  uint256_t rDiv;
  uint256_t rMod;
